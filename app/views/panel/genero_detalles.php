...
if (!isset($_GET["id"])) {
    $_SESSION['message'] = array(
        "type" => "warning",
        "description" => "El genero que tratas de encontrar no existe en la Base de Datos...",
        "title" => "¡Advertencia!"
    );
...
if (empty($usuario)) {
    $_SESSION['message'] = array(
        "type" => "error",
        "description" => "El genero que tratas de editar no existe en la Base de Datos...",
        "title" => "¡ERROR!"
    );
    header("location: ./generos.php");
    exit();
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card card-info">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="form-usuario" action="../../backend/panel/generos/create_genero.php"
                                    method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <center>
                                                    <img src="../../../recursos/img/users/genero.png"
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="id_usuario" class="form-control"
                                                        id="id_usuario" placeholder="Nombre(s)"
